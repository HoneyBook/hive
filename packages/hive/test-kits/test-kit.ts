...
export abstract class TestKit<Dependencies extends Array<TestKit> = any[]> {
  ...
  protected _dependentTestKitsMap: TestKitArrayToRecord<Dependencies> =
    {} as TestKitArrayToRecord<Dependencies>;
  ...
  >(): TestKitArrayToRecord<DepKits> {
    return this._dependentTestKitsMap as unknown as TestKitArrayToRecord<DepKits>;
  }
  ...
  setDependentTestKits(dependentTestKits: Array<TestKit>) {
    ...
    this._dependentTestKitsMap = buildTestKitRecordFromArray(dependentTestKits);
  }
